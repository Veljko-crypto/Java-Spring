...
public class ElementService {
    ...
    public String transform(Element element) {
        ...
        sb.append("Original value: ").append("\n");
        sb.append(element.getValue()).append("\n");
        sb.append("Transformed value: ").append("\n");
    ...
    private String thirdTransformation(String value, Transformer t, StringBuilder result) {
        ...
        for (char character : value.toCharArray()) {
            if ((t.getGroupId().equals("cyrillic") || t.getGroupId().equals("Cyrillic")) && cyrillicToLatinMap.containsKey(character)) {
                result.append(cyrillicToLatinMap.get(character));
            } else if ((t.getGroupId().equals("greek") || t.getGroupId().equals("Greek")) && greekToLatinMap.containsKey(character)) {
